...
* Commands format:
  ...
  enc_dec_key = sha256(lowercase(username) + aes_key) (use this key to encrypt data before sending)
  storage_key = sha256(lowercase(username) + enc_dec_key) (use this key to authenticate user)
