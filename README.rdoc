...
== GLOBAL
* rework JSON output {"webform" => [/* web forms */], "app" => [/* apps */], etc }
...
* add support for aliases (alias=webform/xyz webform/qwe webform/asd - will generate 3 additional entries in HTML)
...
- ? Possibly add feature to plugin to create new web form entries in the database (by just appending to plaintext in cbserve)
