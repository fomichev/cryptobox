...
templates['locked'] = template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  return "<div data-role=\"page\" id=\"div-locked\">\n	<div data-role=\"header\">\n		<h1><%= @text[:enter_password] %></h1>\n	</div>\n\n	<div data-role=\"content\">\n		<div id=\"div-alert\" class=\"ui-bar ui-bar-e\"></div>\n\n		<form id=\"form-unlock\" action=\"#div-main\" method=\"get\" data-ajax=\"false\">\n			<input type=\"password\" id=\"input-password\" value=\"\" placeholder=\"<%= @text[:password] %>\" />\n			<% if @embed %>\n			<input type=\"text\" id=\"input-hostname\" value=\"\" placeholder=\"<%= @text[:hostname] %>\" />\n			<input type=\"text\" id=\"input-username\" value=\"\" placeholder=\"<%= @text[:username] %>\" />\n			<label><input id=\"input-save\" type=\"checkbox\"/ > <%= @text[:save_settings] %></label>\n			<% end %>\n			<input id=\"button-unlock\" type=\"submit\" value=\"<%= @text[:button_unlock] %>\" />\n		</form>\n	</div>\n</div>\n";});
...
function program4(depth0,data,depth1) {
  ...
  buffer += "\n			";
  stack1 = depth0.item;
  stack1 = helpers.each.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.programWithDepth(program7, data, depth1)});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n		";
  return buffer;}
...
function program14(depth0,data) {
  ...
  stack2['to'] = "webform";
  foundHelper = helpers.if_eq;
  stack1 = foundHelper ? foundHelper.call(depth0, stack1, {hash:stack2,inverse:self.program(20, program20, data),fn:self.program(15, program15, data)}) : helperMissing.call(depth0, "if_eq", stack1, {hash:stack2,inverse:self.program(20, program20, data),fn:self.program(15, program15, data)});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n			</div>\n		</div>\n		";
  return buffer;}
